...
void Corridor (void){
  ...
  while((proximity_data < 140) && (w1 < 70) && (w2 < 70) && (w3 < 70) && (w4 < 70)){
    if(enc_getLeft() < enc_getRight()){//More power needs to go to left0
      analogWrite(5, 80 + 15*(enc_getRight()-enc_getLeft()));
      analogWrite(6, 80 - 15*(enc_getRight()-enc_getLeft()));
    }
